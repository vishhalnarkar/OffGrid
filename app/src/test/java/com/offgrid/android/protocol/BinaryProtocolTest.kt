...
class BinaryProtocolTest {
     ...
     * anything it can't parse as a valid OffGridPacket.
     */
    @Test
    ...
    private fun roundTrip(packet: OffGridPacket): OffGridPacket {
    ...
    private fun assertPacketEquals(expected: OffGridPacket, actual: OffGridPacket) {
