package com.offgrid.android.service
...
import com.offgrid.android.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "OffGrid_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "com.offgrid.android.service.START"
        const val ACTION_STOP = "com.offgrid.android.service.STOP"
        const val ACTION_QUIT = "com.offgrid.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.offgrid.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.offgrid.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_OffGrid),
                quitPendingIntent
            )
            .build()
    }
