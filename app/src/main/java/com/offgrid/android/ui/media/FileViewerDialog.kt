...
import com.offgrid.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: OffGridFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("OffGrid_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
