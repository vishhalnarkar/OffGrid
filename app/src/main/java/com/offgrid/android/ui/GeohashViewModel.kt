...
import com.offgrid.android.nostr.GeohashMessageHandler
import com.offgrid.android.nostr.GeohashRepository
import com.offgrid.android.nostr.NostrDirectMessageHandler
import com.offgrid.android.nostr.NostrIdentityBridge
import com.offgrid.android.nostr.NostrProtocol
import com.offgrid.android.nostr.NostrRelayManager
import com.offgrid.android.nostr.NostrSubscriptionManager
import com.offgrid.android.nostr.PoWPreferenceManager
import com.offgrid.android.nostr.GeohashAliasRegistry
import com.offgrid.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.offgrid.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.offgrid.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.offgrid.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.offgrid.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.offgrid.android.model.OffGridMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.offgrid.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.offgrid.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.offgrid.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.offgrid.android.model.OffGridMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.offgrid.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.offgrid.android.geohash.ChannelID.Mesh -> {
            ...
            is com.offgrid.android.geohash.ChannelID.Location -> {
