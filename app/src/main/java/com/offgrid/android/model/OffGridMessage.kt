...
@Parcelize
enum class OffGridMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * OffGridMessage - 100% compatible with iOS version
 */
@Parcelize
data class OffGridMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: OffGridMessageType = OffGridMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): OffGridMessage? {
            try {
                ...
                return OffGridMessage(
                    ...
                    sender = sender,
                    content = content,
                    type = OffGridMessageType.Message,
                    timestamp = timestamp,
                    isRelay = isRelay,
