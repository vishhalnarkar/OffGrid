package com.offgrid.android.noise

import android.content.Context
import android.util.Log
import com.offgrid.android.identity.SecureIdentityStateManager
import com.offgrid.android.mesh.PeerFingerprintManager
import com.offgrid.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.offgrid.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.offgrid.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.offgrid.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a OffGridPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.offgrid.android.protocol.OffGridPacket): com.offgrid.android.protocol.OffGridPacket? {
    ...
    /**
     * Verify a OffGridPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.offgrid.android.protocol.OffGridPacket, publicKey: ByteArray): Boolean {
