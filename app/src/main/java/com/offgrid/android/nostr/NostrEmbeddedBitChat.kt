...
object NostrEmbeddedBitChat {
    ...
    /**
     * Build a `OffGrid1:` base64url-encoded OffGrid packet carrying a private message for Nostr DMs.
     */
    fun encodePMForNostr(
        ...
        try {
            ...
            return "OffGrid1:" + base64URLEncode(data)
        } catch (e: Exception) {
    ...
    /**
     * Build a `OffGrid1:` base64url-encoded OffGrid packet carrying a delivery/read ack for Nostr DMs.
     */
    ...
    /**
     * Build a `OffGrid1:` ACK (delivered/read) without an embedded recipient peer ID (geohash DMs).
     */
    ...
    /**
     * Build a `OffGrid1:` payload without an embedded recipient peer ID (used for geohash DMs).
     */
