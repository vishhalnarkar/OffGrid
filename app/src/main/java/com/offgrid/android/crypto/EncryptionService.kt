package com.offgrid.android.crypto
...
import com.offgrid.android.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in OffGrid.
...
open class EncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val OLD_PREFS_NAME = "OffGrid_crypto"
        private const val SECURE_PREFS_NAME = "OffGrid_crypto_secure"
    }
