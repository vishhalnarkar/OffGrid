package com.offgrid.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.offgrid.android.model.OffGridFilePacket
    ): String {
    ...
    /**
     * Classify OffGridMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.offgrid.android.model.OffGridMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.offgrid.android.model.OffGridMessageType.Image
            lower.startsWith("audio/") -> com.offgrid.android.model.OffGridMessageType.Audio
            else -> com.offgrid.android.model.OffGridMessageType.File
        }
    }
