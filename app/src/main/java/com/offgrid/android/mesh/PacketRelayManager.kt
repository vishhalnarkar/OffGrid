 ...
 * 
 * This class handles all relay decisions and logic for OffGrid packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.offgrid.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: OffGridPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: OffGridPacket, fromPeerID: String): Boolean {
