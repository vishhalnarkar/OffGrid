...
class BluetoothGattServerManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!com.offgrid.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value) {
    ...
    private fun startAdvertising() {
        // Respect debug setting
        val enabled = try { com.offgrid.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true }
