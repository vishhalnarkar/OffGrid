...
import com.offgrid.android.model.FragmentPayload
...
class FragmentManager {
    ...
    companion object {
        ...
        private const val FRAGMENT_SIZE_THRESHOLD = com.offgrid.android.util.AppConstants.Fragmentation.FRAGMENT_SIZE_THRESHOLD // Matches iOS: if data.count > 512
        private const val MAX_FRAGMENT_SIZE = com.offgrid.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE        // Matches iOS: maxFragmentSize = 469 
        private const val FRAGMENT_TIMEOUT = com.offgrid.android.util.AppConstants.Fragmentation.FRAGMENT_TIMEOUT_MS     // Matches iOS: 30 seconds cleanup
        private const val CLEANUP_INTERVAL = com.offgrid.android.util.AppConstants.Fragmentation.CLEANUP_INTERVAL_MS     // 10 seconds cleanup check
    }
     ...
     */
    fun createFragments(packet: OffGridPacket): List<OffGridPacket> {
        try {
        ...
        val fragments = mutableListOf<OffGridPacket>()
        ...
        for (index in fragmentChunks.indices) {
            ...
            val fragmentPacket = OffGridPacket(
     ...
     */
    fun handleFragment(packet: OffGridPacket): OffGridPacket? {
        ...
        try {
            ...
            val maxFragments = com.offgrid.android.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
            ...
            synchronized(fragmentStateLock) {
                ...
                if (isNewSet) {
                    val maxActive = com.offgrid.android.util.AppConstants.Fragmentation.MAX_ACTIVE_FRAGMENT_SETS
                ...
                val maxTotalBytes = com.offgrid.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_TOTAL_BYTES
                ...
                val maxGlobalBytes = com.offgrid.android.util.AppConstants.Fragmentation.MAX_GLOBAL_FRAGMENT_TOTAL_BYTES
                ...
                if (fragmentMap.size == expectedTotal) {
                    ...
                    val originalPacket = OffGridPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: OffGridPacket)
}
